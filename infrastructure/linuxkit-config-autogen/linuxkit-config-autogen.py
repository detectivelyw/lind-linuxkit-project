...
for container in containers: 
  ...
  OutputFileName1 = "/home/detectivelyw/Documents/projects/tracks/popular-paths-scripts/linuxkit-auto-script-" + str(num) + "-" + container + ".sh"
  with open(OutputFileName1, "w") as f:
    f.write(newText1)
  f.close()

  InputFileName2 = "template-gcov.yml"
  ...
  OutputFileName2 = "/home/detectivelyw/Documents/projects/tracks/linuxkit/" + container + "-gcov.yml"
...
OutputFileName3 = "/home/detectivelyw/Documents/projects/tracks/tools/linuxkit-config-autogen/autorun.sh"
with open(OutputFileName3, "w") as f:
  Text1 = "#!/bin/bash\nsudo chmod 777 ../../popular-paths-scripts/linuxkit-auto-script-*\n"
  f.write(Text1)
  for container in containers: 
    Text2 = "cd $KITSRC\nsudo linuxkit build -disable-content-trust "+ container +"-gcov.yml\ncd ../linuxkit-auto-experiment/\n./run-linuxkit-auto.sh "+ container +" 1 10\n"
    f.write(Text2)
f.close()
